...
class Janrain_Share_Block_Info extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {
    ...
    protected function _getFieldHtml($fieldset) {
        $content = '<p>Janrain Share for Magento ' . Mage::getConfig()->getModuleConfig("Janrain_Share")->version . '</p>';
